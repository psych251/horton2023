...
## Methods
The overarching strategy for the large language model-based studies we are attempting to replicate involves describing well-known social science experiments in natural language scenarios. We then prompt a language model to answer the question, "If you were a participant, how would you behave in this scenario?" We aim to replicate three well-known social scientific experiments previously studied by Horton: Charness and Rabin (2002) [6], Kahneman, Knetsch, and Thaler (1986) [7], and Samuelson and Zeckhauser (1988) [8].
